...
public class CustomerDataController {
    ...
    @PostMapping(path="/data/{customerid}/{dialogid}", consumes= {"application/json"})
    public CustomerData addCustomerData(@RequestBody CustomerData data, @PathVariable int customerid, @PathVariable int dialogid){
        data.setId(dialogid);
        System.out.println("Customer ID: " + customerid + ", Dialog ID: " + dialogid);
        repo.save(data);
        return data;
    }
